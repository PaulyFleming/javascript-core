...
let monthlySales = Array.of(500,9000,3000,450);
let monthlyLabels = Array.of('Oct', 'Nov', 'Dec');

let deptSales = Array.of(12,9,3);
let deptLabels = Array.of('Hiking', 'FIshing', 'Fighting');
...
let novNums = Array.of(1100,4000,900);
let decNums = Array.of(1800,1350,5600);
